...
## Corpus Check
- 323 files · ~473,214 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4878 nodes · 6269 edges · 360 communities (281 shown, 76 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be790f6b`
...
Cohesion: 0.16
Nodes (22): PATCH(), RouteContext, PATCH(), rejectSchema, RouteContext, GET(), PATCH(), resolveReportSchema (+14 more)
...
Cohesion: 0.11
Nodes (15): CategoryOption, EditListingPageProps, CategoryOption, adminNavLinks, PendingListing, AdminOverviewPage(), CategoryOption, ListingForm() (+7 more)
...
Cohesion: 0.11
Nodes (21): DashboardPage(), EditListingPage(), ProfileForm, ProfilePage(), handleSave(), validate(), YEAR_OPTIONS, SellPage() (+13 more)
...
### Community 52 - "react"
Cohesion: 0.08
Nodes (30): SellerListing, TabType, PendingReport, BrowseContent(), CategoryItem, ListingDetailClient(), ListingDetailClientProps, conditionBadges (+22 more)
...
### Community 158 - "_style_is_dark_primary"
Cohesion: 0.21
...
### Community 219 - "generate_design_system"
Cohesion: 0.22
...
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `.trae/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py`, `read_rows`, `.agents/skills/ui-ux-pro-max/scripts/design_system.py`, `read_rows`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py`, `DesignSystemGenerator`, `parse_decision_rules`, `generate_design_system`, `.generate`, `BM25`?**
