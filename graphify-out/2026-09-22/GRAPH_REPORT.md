# Graph Report - Unideal  (2026-09-22)

## Corpus Check
- 342 files · ~483,553 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4949 nodes · 6398 edges · 370 communities (289 shown, 78 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `303da58e`
...
- .generate
- padding-y
- .trae/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py
...
### Community 0 - ".agents/skills/ui-ux-pro-max/scripts/validate_data.py"
Cohesion: 0.07
...
### Community 1 - ".trae/skills/ui-ux-pro-max/scripts/validate_data.py"
Cohesion: 0.07
Nodes (48): Semantic quality contracts for the core UI/UX datasets., read_rows(), TestAccessibilityGuidance, TestChartsTypographyAndIcons, TestCurrentReactGuidance, TestSemanticColors, _catalog_date(), _check_app_interface_contract() (+40 more)
...
### Community 4 - ".trae/skills/design-system/scripts/slide_search_core.py"
Cohesion: 0.08
...
### Community 6 - ".trae/skills/design-system/scripts/html-token-validator.py"
Cohesion: 0.12
...
### Community 10 - ".trae/skills/ui-ux-pro-max/scripts/design_system.py"
Cohesion: 0.07
...
### Community 11 - ".trae/skills/design/scripts/icon/generate.py"
Cohesion: 0.18
...
### Community 15 - ".agents/skills/ui-ux-pro-max/scripts/core.py"
Cohesion: 0.11
...
### Community 19 - "Canvas Design System"
Cohesion: 0.06
Nodes (35): 1. Visual Communication First, 2. Minimal Text Integration, 3. Expert Craftsmanship, 4. Systematic Patterns, Analog Meditation, Approach, Canvas Boundaries, Canvas Design System (+27 more)

### Community 20 - "TestThresholdGate"
Cohesion: 0.12
...
### Community 21 - "spacing"
Cohesion: 0.09
Nodes (22): $type, $value, $type, $value, $type, $value, $type, $value (+14 more)

### Community 22 - "OurStoryClient.tsx"
Cohesion: 0.14
Nodes (11): OurStoryClient(), useSection(), IlluAlmirah(), items, features, IlluBuilt(), IlluGap(), IlluPositioning() (+3 more)

### Community 23 - "package.json"
Cohesion: 0.12
Nodes (14): name, private, version, autoprefixer, eslint, eslint-config-next, postcss, react-dom (+6 more)

### Community 24 - ".trae/skills/design-system/scripts/generate-slide.py"
Cohesion: 0.14
...
### Community 26 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 27 - "search_stack"
Cohesion: 0.10
...
Cohesion: 0.14
Nodes (24): PATCH(), RouteContext, PATCH(), rejectSchema, RouteContext, GET(), GET(), PATCH() (+16 more)

### Community 31 - "Form & Input Components"
Cohesion: 0.06
Nodes (32): Accordion, Alert, Alert Dialog, Avatar, Badge, Button, Card, Checkbox (+24 more)

### Community 32 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)
...
### Community 36 - ".trae/skills/ui-ux-pro-max/scripts/core.py"
Cohesion: 0.11
Nodes (28): _contains_phrase(), _domain_keywords(), _exact_stack_identifier(), _file_signature(), _get_bm25(), _load_csv(), _load_csv_snapshot(), _load_product_keywords() (+20 more)

### Community 37 - "ListingForm.tsx"
Cohesion: 0.14
Nodes (15): RouteContext, CategoryOption, InitialListingData, ListingForm(), ListingFormProps, CLOUDINARY_MAX_FILE_SIZE_BYTES, CLOUDINARY_MAX_IMAGES, CloudinaryUploadResponse (+7 more)

### Community 38 - "Typography Specifications"
Cohesion: 0.06
Nodes (30): Accessibility, Base System, Best Practices, Clean & Modern, Common Font Pairings, Contrast Requirements, CSS Implementation, Editorial (+22 more)

### Community 39 - "react"
Cohesion: 0.07
Nodes (33): DashboardPage(), CategoryOption, EditListingPage(), EditListingPageProps, ProfileForm, ProfilePage(), handleSave(), validate() (+25 more)
...
### Community 44 - "shadcn/ui Accessibility Patterns"
Cohesion: 0.07
Nodes (28): Accordion, Alert, ARIA Labels, Checkbox and Radio, Color Contrast, Command Palette Navigation, Component-Specific Patterns, Dialog/Modal Navigation (+20 more)
...
### Community 50 - "Asset Approval Checklist"
Cohesion: 0.08
...
### Community 51 - "Logo AI Prompt Engineering"
Cohesion: 0.08
Nodes (25): Common Pitfalls, Core Prompt Structure, Detailed Brief, Eco/Sustainable, Effective Keywords by Style, Fashion Brand, Healthcare, Industry-Specific Prompts (+17 more)

### Community 52 - "[slug]/page.tsx"
Cohesion: 0.11
Nodes (19): BrowseContent(), CategoryItem, ListingDetailClient(), ListingDetailClientProps, conditionBadges, ListingDetailPage(), ListingDetailPageProps, ListingDetailRow (+11 more)
...
### Community 66 - ".trae/skills/design/scripts/logo/core.py"
Cohesion: 0.10
...
### Community 67 - "detect_domain"
Cohesion: 0.23
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection

### Community 68 - "Workflow"
Cohesion: 0.08
Nodes (23): Art Direction Styles (Reuse from Banner), Color & Contrast, Design Best Practices, HTML Design Rules, HTML Template Structure, Option A: Chrome Headless CLI (Recommended — zero dependencies), Option B: chrome-devtools skill, Option C: Playwright script (+15 more)

### Community 69 - ".trae/skills/design/scripts/cip/core.py"
Cohesion: 0.06
...
### Community 72 - "Tailwind CSS Customization"
Cohesion: 0.09
...
### Community 77 - "spacing"
Cohesion: 0.09
Nodes (22): $type, $value, $type, $value, $type, $value, $type, $value (+14 more)

### Community 78 - ".agents/skills/design-system/scripts/html-token-validator.py"
Cohesion: 0.12
Nodes (25): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+17 more)

### Community 79 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py"
Cohesion: 0.20
...
### Community 80 - "Routing by Task Type"
Cohesion: 0.10
...
### Community 82 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
...
### Community 83 - "(public)/page.tsx"
Cohesion: 0.08
Nodes (18): POST(), RouteContext, reportSchema, RouteContext, validReportReasons, RouteContext, GET(), GET() (+10 more)

### Community 84 - "Routing by Task Type"
Cohesion: 0.10
Nodes (19): Banner Design Tasks, Brand Identity Tasks, Component Creation, Corporate Identity Program Tasks, Design Routing Guide, Design System Migration, Icon Design Tasks, Implementation Tasks (+11 more)

### Community 85 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
Nodes (19): Base Color Presets, Best Practices, Color Customization, Color Format, Component Customization, CSS Variable System, Customize Styles, Customize Variants (+11 more)

### Community 86 - "Asset Organization Guide"
Cohesion: 0.11
...
### Community 87 - "Primary Color Meanings"
Cohesion: 0.11
...
### Community 90 - "Asset Organization Guide"
Cohesion: 0.11
Nodes (18): Asset Entry (manifest.json), Asset Organization Guide, By Campaign, By Status, By Type, Cleanup Workflow, Components, Directory Structure (+10 more)

### Community 91 - "Primary Color Meanings"
Cohesion: 0.11
Nodes (18): Accessibility Considerations, Analogous, Black, Blue, Color Combinations by Industry, Color Harmony Types, Complementary, Green (+10 more)

### Community 92 - "Core Logo Types"
Cohesion: 0.11
Nodes (18): 1. Wordmark (Logotype), 2. Lettermark (Monogram), 3. Pictorial Mark (Brand Mark), 4. Abstract Mark, 5. Mascot, 6. Emblem, 7. Combination Mark, Aesthetic Styles (+10 more)
...
### Community 103 - ".agents/skills/ui-ux-pro-max/scripts/design_system.py"
Cohesion: 0.07
Nodes (32): ansi_ljust(), _detect_page_type(), format_ascii_box(), format_markdown(), format_master_md(), format_page_override_md(), generate_design_system(), _generate_intelligent_overrides() (+24 more)

### Community 104 - "Design Principles"
Cohesion: 0.12
...
### Community 111 - "Component Specifications"
Cohesion: 0.07
Nodes (28): Alert, Anatomy, Anatomy, Anatomy, Anatomy, Anatomy, Badge, Button (+20 more)

### Community 112 - "fontSize"
Cohesion: 0.12
Nodes (16): $type, $value, $type, $value, $type, $value, $type, $value (+8 more)

### Community 113 - "CIP Design Reference"
Cohesion: 0.13
...
### Community 114 - "Icon Design Reference"
Cohesion: 0.13
...
### Community 115 - "Copywriting Formulas"
Cohesion: 0.13
...
### Community 118 - "CIP Design Reference"
Cohesion: 0.13
Nodes (14): CIP Brief (Start Here), CIP Design Reference, Commands, Deliverable Categories, Design Styles, Detailed References, Generate Mockups, HTML Presentation Features (+6 more)

### Community 119 - "Icon Design Reference"
Cohesion: 0.13
Nodes (14): Available Styles, CLI Options, Commands, Generate Batch Variations, Generate Multiple Sizes, Generate Single Icon, Icon Categories, Icon Design Reference (+6 more)
...
### Community 122 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
...
### Community 125 - ".agents/skills/brand/scripts/extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 126 - ".agents/skills/brand/scripts/validate-asset.cjs"
Cohesion: 0.25
...
### Community 128 - ".agents/skills/design/scripts/cip/core.py"
Cohesion: 0.06
Nodes (46): BM25, detect_domain(), get_cip_brief(), _load_csv(), Load CSV and return list of dicts, Core search function using BM25, Auto-detect the most relevant domain from query, Main search function with auto-domain detection (+38 more)
...
### Community 130 - ".agents/skills/design-system/scripts/generate-slide.py"
Cohesion: 0.14
Nodes (20): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+12 more)
...
### Community 134 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
Nodes (13): Art Direction Styles (Top 10), Banner Design - Multi-Format Creative Banner System, Banner Size Quick Reference, Design Rules, Prerequisites, Security, Step 1: Gather Requirements (AskUserQuestion), Step 2: Research & Art Direction (+5 more)

### Community 135 - "Messaging Framework"
Cohesion: 0.14
Nodes (13): Core Statements, Elevator Pitches, Framework Structure, Message Architecture, Message by Audience, Message Testing, Messaging Framework, Mission Statement (+5 more)

### Community 136 - "Brand Voice Framework"
Cohesion: 0.14
Nodes (13): Brand Voice Framework, Character Spectrum, Emotion Spectrum, Language Spectrum, Step 1: Define Personality Traits, Step 2: Create Voice Chart, Step 3: Context Adaptation, Tone Spectrum (+5 more)

### Community 137 - ".trae/skills/brand/scripts/extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 138 - ".trae/skills/brand/scripts/validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)
...
### Community 143 - ".agents/skills/brand/references/update.md"
Cohesion: 0.15
...
### Community 144 - "Logo Design Reference"
Cohesion: 0.15
...
### Community 145 - "Token Architecture"
Cohesion: 0.15
...
### Community 146 - ".agents/skills/design-system/templates/design-tokens-starter.json"
Cohesion: 0.15
...
### Community 148 - "@supabase/supabase-js"
Cohesion: 0.15
Nodes (5): @supabase/supabase-js, { createClient }, { createClient }, { createClient }, { createClient }

### Community 149 - ".trae/skills/brand/references/update.md"
Cohesion: 0.15
Nodes (12): Color Presets, Examples, Files Modified, Important, Overview, Skills Used, Step 1: Gather Brand Input, Step 2: Update Brand Guidelines (+4 more)

### Community 150 - "Logo Design Reference"
Cohesion: 0.15
Nodes (12): Available Styles, Color Psychology, Commands, Design Brief (Start Here), Detailed References, Generate Logo, Industry Defaults, Logo Design Reference (+4 more)

### Community 151 - "DesignSystemGenerator"
Cohesion: 0.14
Nodes (6): DesignSystemGenerator, Generates design system recommendations from aggregated searches., Load reasoning rules from CSV., TestReasoningMatch, read_rows(), TestReasoningContract

### Community 152 - "Token Architecture"
Cohesion: 0.15
Nodes (12): Categories, Dark Mode, File Organization, Layer 1: Primitive Tokens, Layer 2: Semantic Tokens, Layer 3: Component Tokens, Layer Overview, Migration from Flat Tokens (+4 more)

### Community 153 - ".trae/skills/design-system/templates/design-tokens-starter.json"
Cohesion: 0.15
Nodes (12): component, $type, $value, dark, semantic, $schema, $type, $value (+4 more)

### Community 154 - "Primitive Tokens"
Cohesion: 0.17
...
### Community 155 - ".agents/skills/design-system/scripts/validate-tokens.cjs"
Cohesion: 0.26
...
### Community 158 - ".agents/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py"
Cohesion: 0.14
...
### Community 159 - "Primitive Tokens"
Cohesion: 0.17
Nodes (11): Border Radius, Color Scales, Gray Scale, Motion / Duration, Primary Colors (Blue), Primitive Tokens, Shadows, Spacing Scale (+3 more)

### Community 160 - ".trae/skills/design-system/scripts/validate-tokens.cjs"
Cohesion: 0.26
Nodes (11): extensions, formatReport(), fs, getFiles(), main(), parseArgs(), path, patterns (+3 more)
...
### Community 162 - ".agents/skills/brand/scripts/inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 163 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 164 - ".agents/skills/design-system/scripts/embed-tokens.cjs"
Cohesion: 0.18
...
### Community 166 - ".trae/skills/brand/scripts/inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 167 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 168 - ".trae/skills/design-system/scripts/embed-tokens.cjs"
Cohesion: 0.18
Nodes (8): args, fs, minimal, MINIMAL_TOKENS, path, projectRoot, tokensPath, wrapStyle
...
### Community 170 - "Slide Strategies"
Cohesion: 0.20
...
### Community 171 - "Component Tokens"
Cohesion: 0.20
...
### Community 172 - ".agents/skills/design-system/scripts/generate-tokens.cjs"
Cohesion: 0.40
...
### Community 174 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 175 - "listings/route.ts"
Cohesion: 0.20
Nodes (11): SellerListing, TabType, POST(), CategoryItem, conditions, ListingFilters(), ListingFiltersProps, generateNanoId (+3 more)
...
### Community 179 - ".trae/skills/design-system/scripts/generate-tokens.cjs"
Cohesion: 0.40
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)
...
### Community 183 - ".check_shadcn_config"
Cohesion: 0.21
Nodes (6): Add all available shadcn/ui components. Args: overwrite: If True, overwrite…, List installed components. Returns: Tuple of (success, message with component…, Check if shadcn is initialized in project. Returns: True if components.json…, Get list of already installed components. Returns: List of installed component…, Read shadcn version from project package.json; fall back to a pinned default., Add shadcn/ui components. Args: components: List of component names to add…

### Community 184 - "Core Visual Elements"
Cohesion: 0.18
Nodes (10): Color Palette, Colors, Core Visual Elements, Logo, Logo, Quick Checks, Typography, Typography (+2 more)

### Community 185 - ".agents/skills/brand/scripts/sync-brand-to-tokens.cjs"
Cohesion: 0.33
Nodes (8): adjustBrightness(), { execFileSync }, extractColorsFromMarkdown(), fs, generateColorScale(), main(), path, updateDesignTokens()

### Community 186 - "Core Visual Elements"
Cohesion: 0.18
Nodes (10): Color Palette, Colors, Core Visual Elements, Logo, Logo, Quick Checks, Typography, Typography (+2 more)

### Community 187 - ".trae/skills/brand/scripts/sync-brand-to-tokens.cjs"
Cohesion: 0.33
Nodes (8): adjustBrightness(), { execFileSync }, extractColorsFromMarkdown(), fs, generateColorScale(), main(), path, updateDesignTokens()
...
### Community 190 - "Slides Reference"
Cohesion: 0.29
Nodes (6): Key Features, Knowledge Base, Slides Reference, Usage, When to Use, Workflow

### Community 191 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 192 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 193 - "Slides Reference"
Cohesion: 0.29
Nodes (6): Key Features, Knowledge Base, Slides Reference, Usage, When to Use, Workflow

### Community 194 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 195 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 196 - ".trae/skills/design-system/scripts/slide-token-validator.py"
Cohesion: 0.50
...
### Community 197 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 198 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 199 - "Brand Guidelines Template"
Cohesion: 0.40
Nodes (4): Brand Guidelines Template, Document Structure, Extractable Fields, Usage

### Community 201 - ".agents/skills/design/scripts/logo/core.py"
Cohesion: 0.10
Nodes (21): BM25, detect_domain(), _load_csv(), Load CSV and return list of dicts, Core search function using BM25, Auto-detect the most relevant domain from query, Main search function with auto-domain detection, Search across all domains and combine results (+13 more)

### Community 202 - ".agents/skills/design-system/scripts/slide_search_core.py"
Cohesion: 0.08
Nodes (38): format_context(), format_result(), main(), Format a single search result for display, Slide Search CLI - Search slide design databases for strategies, layouts, copy,…, Format contextual recommendations for display., BM25, calculate_pattern_break() (+30 more)

### Community 203 - ".agents/skills/design-system/scripts/fetch-background.py"
Cohesion: 0.16
Nodes (18): generate_css_for_background(), get_background_image(), get_curated_images(), get_overlay_css(), get_pexels_search_url(), load_backgrounds_config(), load_brand_colors(), main() (+10 more)
...
### Community 211 - "Brand Guidelines Template"
Cohesion: 0.40
Nodes (4): Brand Guidelines Template, Document Structure, Extractable Fields, Usage

### Community 212 - ".agents/skills/design/scripts/icon/generate.py"
Cohesion: 0.18
Nodes (16): apply_color(), apply_viewbox_size(), extract_svgs(), generate_batch(), generate_icon(), generate_sizes(), load_env(), main() (+8 more)
...
### Community 216 - ".agents/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py"
Cohesion: 0.19
...
### Community 217 - "_palette_is_dark"
Cohesion: 0.18
Nodes (7): _palette_is_dark(), WCAG relative luminance of a #RRGGBB string, or None if unparseable., True when a colors.csv row's Background is a dark surface., _relative_luminance(), The exact reproduction from issue #428., TestEndToEndCoherence, TestLuminance

### Community 218 - "parse_decision_rules"
Cohesion: 0.27
...
### Community 222 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py"
Cohesion: 0.19
Nodes (5): Cross-file semantic contracts for curated design data., split_values(), style_identities(), TestLandingAndStackContract, TestStyleIdentityContract

### Community 223 - "Row Level Security Policies"
Cohesion: 0.50
Nodes (4): System Topology, Security Boundaries, Row Level Security Policies, Supabase Architecture

### Community 224 - "padding-y"
Cohesion: 0.67
Nodes (4): padding-y, padding-y, $type, $value
...
### Community 226 - "UniDeal — QA Findings Report"
Cohesion: 0.17
...
### Community 227 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 228 - "destructive-foreground"
Cohesion: 0.67
...
### Community 230 - "primary-foreground"
Cohesion: 0.67
...
### Community 233 - "TestShadcnInstaller"
Cohesion: 0.12
Nodes (9): Tests for shadcn_add.py, Test ShadcnInstaller class., Test adding all components without config., Test listing installed components without config., Test listing installed components when they exist., Test initialization with default project root., Test initialization with dry run mode., Test getting installed components when files exist. (+1 more)
...
### Community 241 - "ShadcnInstaller"
Cohesion: 0.17
Nodes (8): main(), Handle shadcn/ui component installation., shadcn/ui Component Installer Add shadcn/ui components to project with…, ShadcnInstaller, Test adding all components in dry run mode., Test listing installed components when none exist., Test checking for non-existent shadcn config., Test getting installed components without config.

### Community 242 - ".generate_config_string"
Cohesion: 0.20
Nodes (6): Generate configuration file content. Returns: Configuration file as string, Generate TypeScript configuration., Generate JavaScript configuration., Format plugins array for config. Validates each plugin name against a strict…, Add indentation to JSON string., Write configuration to file. Returns: Tuple of (success, message)

### Community 243 - ".generate_config_string"
Cohesion: 0.20
Nodes (6): Generate configuration file content. Returns: Configuration file as string, Generate TypeScript configuration., Generate JavaScript configuration., Format plugins array for config. Validates each plugin name against a strict…, Add indentation to JSON string., Write configuration to file. Returns: Tuple of (success, message)

### Community 244 - "TestTailwindConfigGenerator"
Cohesion: 0.07
Nodes (15): Test adding colors multiple times., Test adding custom fonts., Test adding custom breakpoints., Test TailwindConfigGenerator class., Test plugin recommendations for Next.js., Test generating JavaScript configuration., Test generating config with custom colors., Test validating config with no content paths. (+7 more)

### Community 247 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py"
Cohesion: 0.14
Nodes (11): _filter_anti_patterns_for_mode(), _query_wants_dark(), True when a styles.csv row describes itself as dark-first., True when the query explicitly asks for a dark theme., Resolve the mode the rest of the output has to agree with., Drop "avoid dark mode" advice once dark mode is the resolved answer., _resolve_color_mode(), _style_is_dark_primary() (+3 more)

### Community 248 - ".agents/skills/design/scripts/logo/generate.py"
Cohesion: 0.25
...
### Community 252 - ".agents/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py"
Cohesion: 0.22
Nodes (8): parametrize, Tests for tailwind_config_gen.py, Reduce a generated TS/JS config to a bare assignable object so it can be handed…, Regression guard for the missing-comma bug between the ``theme`` block and…, The property preceding ``plugins`` must end with a comma (pure-Python check, so…, The emitted config parses as valid JS via ``node --check``., _strip_to_object(), TestGeneratedConfigIsValidJs

### Community 259 - ".agents/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py"
Cohesion: 0.20
Nodes (4): Canonical regression contracts for resilient UI text layouts., read_rows(), TestTextLayoutDataContracts, TestTextLayoutRetrieval

### Community 261 - ".trae/skills/design/scripts/logo/generate.py"
Cohesion: 0.25
Nodes (10): enhance_prompt(), generate_batch(), generate_logo(), load_env(), main(), Enhance the logo prompt with style and industry modifiers, Generate a logo using Gemini models with image generation Args: aspect_ratio:…, Generate multiple logo variants with different styles (+2 more)

### Community 262 - "Moderation Flow"
Cohesion: 0.67
Nodes (3): Moderation Flow, Phase 4 Moderation, Listing Approval Modes

### Community 263 - "Profiles Schema"
Cohesion: 0.67
Nodes (3): First-Name Seller Identity, Listings Schema, Profiles Schema

### Community 264 - "ContactForm.tsx"
Cohesion: 0.29
Nodes (6): POST(), FieldErrors, getResendClient(), ContactInput, contactSchema, resend

### Community 265 - "dependencies"
Cohesion: 0.18
Nodes (11): dependencies, framer-motion, lucide-react, nanoid, next, react, react-dom, resend (+3 more)

### Community 266 - "_normalize"
Cohesion: 0.22
...
### Community 267 - "seed_admin_and_listings.js"
Cohesion: 0.20
Nodes (7): nanoid, { createClient }, DUMMY_LISTINGS, envPath, fs, path, seed()

### Community 268 - "_row_identities"
Cohesion: 0.25
...
### Community 269 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 270 - "destructive-foreground"
Cohesion: 0.67
Nodes (3): destructive-foreground, $type, $value
...
### Community 274 - "secondary-foreground"
Cohesion: 0.67
Nodes (3): secondary-foreground, $type, $value

### Community 278 - "._base_config"
Cohesion: 0.22
Nodes (6): Any, Path, Initialize generator. Args: typescript: If True, generate .ts config, else .js…, Determine default output path., Create base configuration structure., Get default content paths for framework.

### Community 279 - "_normalize"
Cohesion: 0.22
Nodes (9): _exact_match_diagnostic(), _legacy_successor_guidance(), _normalize(), Apply longest-first synonym substitution at token boundaries., Whether a stack query explicitly targets an older framework generation., Choose one coherent applicability generation for stack retrieval., Prefer the explicit successor row for a brand-new app on legacy-only stacks., _stack_query_requests_legacy() (+1 more)

### Community 280 - "next"
Cohesion: 0.15
Nodes (8): metadata, metadata, steps, metadata, ContactForm(), handleSubmit(), validate(), next

### Community 281 - "_run"
Cohesion: 0.28
Nodes (8): CompletedProcess, Path, Regression tests for validate-tokens.cjs. The validator used to skip any line…, A hardcoded hex on the same line as a var() token is still a violation., A line that references only tokens produces no false positives., _run(), test_flags_hardcoded_hex_sharing_line_with_token(), test_token_only_line_reports_no_violation()

### Community 282 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 299 - "ui-ux-pro-max"
Cohesion: 0.25
Nodes (7): How to Use, Primary Use Cases, Recommended, Rule Categories by Priority, Skip, ui-ux-pro-max, When to Apply

### Community 300 - "_row_identities"
Cohesion: 0.25
Nodes (8): _exact_row_identity(), Suggest complete public identities so a retry can bypass score thresholds., Return non-empty public identities from ordinary and alias fields., Resolve an explicit style identity without opening generic variant ranking., Return one row whose stable public identity exactly matches the query., _row_identities(), _style_identity(), _suggest_identities()

### Community 301 - "Query Contract"
Cohesion: 0.29
...
### Community 312 - "Tips for Better Results"
Cohesion: 0.50
...
### Community 360 - "admin/layout.tsx"
Cohesion: 0.50
Nodes (3): AdminLayout(), adminNavLinks, AdminShell()

### Community 361 - "scripts"
Cohesion: 0.40
...
## Knowledge Gaps
- **2045 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2040 more)
...
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `_palette_is_dark`, `.agents/skills/ui-ux-pro-max/scripts/design_system.py`, `DesignSystemGenerator`, `_select_palette_for_mode`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py`, `_palette_is_dark`, `.generate`, `BM25`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `TestReasoningMatch` connect `DesignSystemGenerator` to `BM25`, `DesignSystemGenerator`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `search_stack()` connect `search_stack` to `.trae/skills/ui-ux-pro-max/scripts/core.py`, `BM25`, `.trae/skills/ui-ux-pro-max/scripts/design_system.py`, `.trae/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py`, `search`, `_normalize`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
...
- **Should `.agents/skills/ui-ux-pro-max/scripts/validate_data.py` be split into smaller, more focused modules?**
