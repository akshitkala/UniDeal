...
## Corpus Check
- 324 files · ~473,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4880 nodes · 6273 edges · 354 communities (275 shown, 76 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c32cc892`
...
- TestThresholdGate
- spacing
- .trae/skills/ui-ux-pro-max/scripts/tests/test_core_data_quality.py
- package.json
...
Cohesion: 0.07
Nodes (13): DesignSystemGenerator, Generates design system recommendations from aggregated searches., Load reasoning rules from CSV., Select best matching result based on priority keywords., TestReasoningMatch, Cross-file semantic contracts for curated design data., read_rows(), split_values() (+5 more)
...
### Community 22 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_core_data_quality.py"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (29): dependencies, lucide-react, nanoid, next, react, react-dom, resend, @supabase/ssr (+21 more)
...
Cohesion: 0.15
Nodes (23): PATCH(), RouteContext, PATCH(), rejectSchema, RouteContext, GET(), PATCH(), resolveReportSchema (+15 more)
...
### Community 33 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py"
Cohesion: 0.11
...
Cohesion: 0.10
Nodes (16): CategoryOption, EditListingPageProps, CategoryOption, adminNavLinks, PendingListing, AdminOverviewPage(), PendingReport, CategoryOption (+8 more)
...
Cohesion: 0.09
Nodes (24): DashboardPage(), EditListingPage(), ProfileForm, ProfilePage(), handleSave(), validate(), YEAR_OPTIONS, SellPage() (+16 more)
...
### Community 52 - "react"
Cohesion: 0.10
Nodes (26): SellerListing, TabType, BrowseContent(), CategoryItem, ListingDetailClient(), ListingDetailClientProps, conditionBadges, ListingDetailPage() (+18 more)
...
### Community 83 - "listings/route.ts"
Cohesion: 0.09
...
### Community 222 - ".trae/skills/ui-ux-pro-max/scripts/search.py"
Cohesion: 0.50
...
### Community 247 - "_style_is_dark_primary"
Cohesion: 0.21
...
Cohesion: 0.17
Nodes (10): POST(), metadata, ContactForm(), handleSubmit(), validate(), FieldErrors, getResendClient(), ContactInput (+2 more)
...
### Community 280 - "next"
Cohesion: 0.17
Nodes (6): metadata, steps, metadata, howSteps, metadata, next
...
## Knowledge Gaps
- **2024 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2019 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2826 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **76 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `.trae/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py`, `read_rows`, `.agents/skills/ui-ux-pro-max/scripts/design_system.py`, `DesignSystemGenerator`, `_select_palette_for_mode`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py`, `_palette_is_dark`, `parse_decision_rules`, `BM25`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `search_stack()` connect `search_stack` to `.trae/skills/ui-ux-pro-max/scripts/core.py`, `BM25`, `.trae/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py`, `search`, `_normalize`, `.trae/skills/ui-ux-pro-max/scripts/search.py`?**
