...
## Corpus Check
- 358 files · ~547,035 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4990 nodes · 6502 edges · 374 communities (293 shown, 78 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `79f7f598`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- .trae/skills/ui-ux-pro-max/scripts/validate_data.py
- .agents/skills/ui-ux-pro-max/scripts/validate_data.py
- gray
- gray
- TestGeneratedCatalogContract
- .trae/skills/design-system/scripts/slide_search_core.py
- Quick Reference
- .trae/skills/design-system/scripts/html-token-validator.py
- Tailwind CSS Utility Reference
- TestTailwindConfigGenerator
- Tailwind CSS Utility Reference
- .trae/skills/ui-ux-pro-max/scripts/design_system.py
- .trae/skills/design/scripts/icon/generate.py
- read_rows
...
- createAdminClient
- Logo Usage Rules
- .trae/skills/design-system/scripts/fetch-background.py
...
- Workflow
- Workflow
- .trae/skills/design/scripts/cip/core.py
- .trae/skills/design/scripts/logo/core.py
- Design System
...
- .trae/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py
...
- Color Semantics
- patch
- .trae/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py
- ListingForm.tsx
...
- Messaging Framework
- Brand Voice Framework
- .trae/skills/brand/scripts/extract-colors.cjs
- .trae/skills/brand/scripts/validate-asset.cjs
- Layout Patterns
- Tailwind Integration
- Layout Patterns
...
- .trae/skills/brand/references/update.md
- Logo Design Reference
- .agents/skills/design-system/scripts/fetch-background.py
- Token Architecture
- .trae/skills/design-system/templates/design-tokens-starter.json
- Primitive Tokens
...
- Primitive Tokens
- .trae/skills/design-system/scripts/validate-tokens.cjs
- card
- .agents/skills/brand/scripts/inject-brand-context.cjs
- CIP Design Style Guide
- .agents/skills/design-system/scripts/embed-tokens.cjs
- dependencies
- .trae/skills/brand/scripts/inject-brand-context.cjs
- CIP Design Style Guide
- TestThresholdGate
- .trae/skills/design-system/scripts/embed-tokens.cjs
- duration
- Brand
- Slide Strategies
- Component Tokens
...
- Slide Strategies
- Component Tokens
- .trae/skills/design-system/scripts/generate-tokens.cjs
- Slide Strategies
- .check_shadcn_config
...
- server.ts
- Core Visual Elements
- .trae/skills/brand/scripts/sync-brand-to-tokens.cjs
- input
- Slides Reference
- HTML Slide Template
- HTML Slide Template
...
- HTML Slide Template
- HTML Slide Template
- .trae/skills/design-system/scripts/slide-token-validator.py
- Slides
- graphify reference: query, path, explain
- Slides
- Brand Guidelines Template
- .trae/skills/brand/scripts/tests/test_sync_brand_to_tokens.py
...
- .generate_config_string
- .trae/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py
- Contact Reveal API
...
- TestShadcnInstaller
- .trae/skills/design/scripts/logo/generate.py
...
- Auth Modal Design
- Design Tokens
- UniDeal Development Roadmap
- Phase 1 Foundation
- Public Trust and Support Pages
- extraction-spec.md
- .trae/skills/design/references/slides-create.md
- .trae/skills/slides/references/create.md
- vercel.json
- Graphify Workflow
- UniDeal App Flow
...
3. `search()` - 43 edges
4. `search()` - 43 edges
5. `DesignSystemGenerator` - 38 edges
...
- `TestBm25CoreBehavior` --uses--> `BM25`  [INFERRED]
  .trae/skills/ui-ux-pro-max/scripts/tests/test_core.py → .agents/skills/design/scripts/cip/core.py
- `TestTokenizer` --uses--> `BM25`  [INFERRED]
  .trae/skills/ui-ux-pro-max/scripts/tests/test_core.py → .agents/skills/design/scripts/cip/core.py
- `TestShadcnInstaller` --uses--> `ShadcnInstaller`  [INFERRED]
  .trae/skills/ui-styling/scripts/tests/test_shadcn_add.py → .agents/skills/ui-styling/scripts/shadcn_add.py
- `TestGeneratedConfigIsValidJs` --uses--> `TailwindConfigGenerator`  [INFERRED]
  .trae/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py → .agents/skills/ui-styling/scripts/tailwind_config_gen.py
...
### Community 0 - ".trae/skills/ui-ux-pro-max/scripts/validate_data.py"
Cohesion: 0.07
...
### Community 1 - ".agents/skills/ui-ux-pro-max/scripts/validate_data.py"
Cohesion: 0.07
...
### Community 5 - ".trae/skills/design-system/scripts/slide_search_core.py"
Cohesion: 0.08
...
### Community 7 - ".trae/skills/design-system/scripts/html-token-validator.py"
Cohesion: 0.12
...
### Community 8 - "Tailwind CSS Utility Reference"
Cohesion: 0.05
...
### Community 11 - ".trae/skills/ui-ux-pro-max/scripts/design_system.py"
Cohesion: 0.10
...
### Community 15 - "react"
Cohesion: 0.09
Nodes (27): DashboardPage(), CategoryOption, EditListingPage(), EditListingPageProps, ProfileForm, YEAR_OPTIONS, CategoryOption, SellPage() (+19 more)

### Community 16 - "useMotion"
Cohesion: 0.13
Nodes (27): Beat(), OurStoryClient(), PullQuote(), useSection(), HomePage(), metadata, IlluAlmirah(), items (+19 more)

### Community 17 - "Brand Guidelines v1.0"
Cohesion: 0.05
Nodes (37): 1. Color Palette, 2. Typography, 3. Logo Usage, 4. Voice & Tone, 5. Imagery Guidelines, 6. Design Components, Accessibility, AI Image Generation (+29 more)

### Community 18 - ".agents/skills/ui-ux-pro-max/scripts/core.py"
Cohesion: 0.11
...
### Community 23 - "Canvas Design System"
Cohesion: 0.06
Nodes (35): 1. Visual Communication First, 2. Minimal Text Integration, 3. Expert Craftsmanship, 4. Systematic Patterns, Analog Meditation, Approach, Canvas Boundaries, Canvas Design System (+27 more)

### Community 24 - "TestThresholdGate"
Cohesion: 0.12
...
### Community 27 - "spacing"
Cohesion: 0.09
Nodes (22): $type, $value, $type, $value, $type, $value, $type, $value (+14 more)

### Community 28 - ".trae/skills/design-system/scripts/generate-slide.py"
Cohesion: 0.14
...
### Community 30 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 32 - "Form & Input Components"
Cohesion: 0.06
Nodes (32): Accordion, Alert, Alert Dialog, Avatar, Badge, Button, Card, Checkbox (+24 more)

### Community 33 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 34 - "_select_palette_for_mode"
Cohesion: 0.22
...
Cohesion: 0.17
Nodes (20): PATCH(), RouteContext, GET(), GET(), PATCH(), resolveReportSchema, RouteContext, GET() (+12 more)
...
### Community 41 - ".trae/skills/design-system/scripts/fetch-background.py"
Cohesion: 0.16
...
### Community 46 - "_select_palette_for_mode"
Cohesion: 0.22
Nodes (7): _contrast_ratio(), _derive_dark_palette(), WCAG contrast ratio for two hex colors, or None if either is invalid., Keep product brand tokens while deriving accessible dark surfaces., Pick the highest-ranked palette matching the resolved mode. Only the dark case…, _select_palette_for_mode(), TestPaletteSelection
...
### Community 51 - "Asset Approval Checklist"
Cohesion: 0.08
...
### Community 52 - "Logo AI Prompt Engineering"
Cohesion: 0.08
...
### Community 55 - "Color Palette Management"
Cohesion: 0.08
...
### Community 56 - "CIP Deliverable Guide"
Cohesion: 0.08
...
### Community 57 - "States and Variants"
Cohesion: 0.08
...
### Community 62 - "States and Variants"
Cohesion: 0.08
Nodes (24): Accessibility, Accessibility Requirements, ARIA States, Color Contrast, Color Variants, Disabled States, Error Messages, Error States (+16 more)

### Community 63 - "UI Styling Skill"
Cohesion: 0.08
Nodes (24): Accessibility Patterns, Alternative: Tailwind-Only Setup, Best Practices, Common Patterns, Component Layer: shadcn/ui, Component Library Guide, Component + Styling Setup, Core Stack (+16 more)

### Community 64 - "detect_domain"
Cohesion: 0.23
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection
...
### Community 67 - ".trae/skills/design/scripts/cip/core.py"
Cohesion: 0.06
...
### Community 68 - ".trae/skills/design/scripts/logo/core.py"
Cohesion: 0.10
...
### Community 70 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 71 - "TailwindConfigGenerator"
Cohesion: 0.09
Nodes (13): main(), Add custom font families. Args: fonts: Dict of font_type: [font_names] e.g.,…, Add custom spacing values. Args: spacing: Dict of name: value e.g., {'18':…, Add custom breakpoints. Args: breakpoints: Dict of name: width e.g., {'3xl':…, Add plugin requirements. Args: plugins: List of plugin names e.g.,…, Get plugin recommendations based on configuration. Returns: List of recommended…, Tailwind CSS Configuration Generator Generate tailwind.config.js/ts with custom…, Generate Tailwind CSS configuration files. (+5 more)

### Community 72 - "TestShadcnInstaller"
Cohesion: 0.12
...
### Community 73 - "Design System"
Cohesion: 0.09
Nodes (22): Best Practices, Chart.js Integration, Command, Component Spec Pattern, Contextual Decision Flow, Decision System CSVs, Design System, Integration (+14 more)

### Community 74 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 75 - "spacing"
Cohesion: 0.09
Nodes (22): $type, $value, $type, $value, $type, $value, $type, $value (+14 more)

### Community 76 - ".agents/skills/design-system/scripts/html-token-validator.py"
Cohesion: 0.12
Nodes (25): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+17 more)

### Community 77 - ".trae/skills/ui-ux-pro-max/scripts/core.py"
Cohesion: 0.10
...
### Community 78 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py"
Cohesion: 0.20
...
### Community 79 - "Routing by Task Type"
Cohesion: 0.10
...
### Community 80 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
...
### Community 81 - "browse/page.tsx"
Cohesion: 0.15
Nodes (16): SellerListing, TabType, BrowseContent(), CategoryItem, CategoryItem, conditions, ListingFilters(), ListingFiltersProps (+8 more)

### Community 82 - "Routing by Task Type"
Cohesion: 0.10
Nodes (19): Banner Design Tasks, Brand Identity Tasks, Component Creation, Corporate Identity Program Tasks, Design Routing Guide, Design System Migration, Icon Design Tasks, Implementation Tasks (+11 more)

### Community 83 - "fontSize"
Cohesion: 0.12
Nodes (16): $type, $value, $type, $value, $type, $value, $type, $value (+8 more)

### Community 84 - "shadcn/ui Theming & Customization"
Cohesion: 0.10
Nodes (19): Base Color Presets, Best Practices, Color Customization, Color Format, Component Customization, CSS Variable System, Customize Styles, Customize Variants (+11 more)
...
### Community 89 - "Asset Organization Guide"
Cohesion: 0.11
Nodes (18): Asset Entry (manifest.json), Asset Organization Guide, By Campaign, By Status, By Type, Cleanup Workflow, Components, Directory Structure (+10 more)

### Community 90 - "Primary Color Meanings"
Cohesion: 0.11
Nodes (18): Accessibility Considerations, Analogous, Black, Blue, Color Combinations by Industry, Color Harmony Types, Complementary, Green (+10 more)

### Community 91 - "Core Logo Types"
Cohesion: 0.11
Nodes (18): 1. Wordmark (Logotype), 2. Lettermark (Monogram), 3. Pictorial Mark (Brand Mark), 4. Abstract Mark, 5. Mascot, 6. Emblem, 7. Combination Mark, Aesthetic Styles (+10 more)
...
### Community 95 - ".agents/skills/design/scripts/cip/core.py"
Cohesion: 0.06
Nodes (46): BM25, detect_domain(), get_cip_brief(), _load_csv(), Load CSV and return list of dicts, Core search function using BM25, Auto-detect the most relevant domain from query, Main search function with auto-domain detection (+38 more)

### Community 96 - "Color Semantics"
Cohesion: 0.11
...
### Community 98 - "Brand Consistency Checklist"
Cohesion: 0.11
Nodes (17): Audit Frequency, Brand Consistency Checklist, Channel Audit, Collateral, Colors, Common Issues, Email, Imagery (+9 more)

### Community 99 - "CIP Mockup Prompt Engineering"
Cohesion: 0.11
Nodes (17): Apparel (Polo/T-Shirt), Base Prompt Structure, Business Card, CIP Mockup Prompt Engineering, Context Modifiers, Corporate Minimal, Deliverable-Specific Modifiers, Letterhead (+9 more)

### Community 100 - "Color Semantics"
Cohesion: 0.11
Nodes (17): Accent, Applying Semantic Tokens, Background & Foreground, Border & Ring, Color Semantics, Dark Mode Overrides, Destructive, Interactive States (+9 more)
...
### Community 102 - ".trae/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py"
Cohesion: 0.22
...
Cohesion: 0.29
Nodes (9): CategoryOption, InitialListingData, ListingForm(), ListingFormProps, CLOUDINARY_MAX_FILE_SIZE_BYTES, CLOUDINARY_MAX_IMAGES, CloudinaryUploadResponse, getCloudinaryUploadPreset() (+1 more)

### Community 104 - ".agents/skills/ui-ux-pro-max/scripts/design_system.py"
Cohesion: 0.07
...
### Community 106 - "Design Principles"
Cohesion: 0.12
...
### Community 107 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 108 - "Component Specifications"
Cohesion: 0.07
...
### Community 112 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 113 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 114 - "Component Specifications"
Cohesion: 0.07
Nodes (28): Alert, Anatomy, Anatomy, Anatomy, Anatomy, Anatomy, Badge, Button (+20 more)

### Community 115 - "CIP Design Reference"
Cohesion: 0.13
...
### Community 116 - "Icon Design Reference"
Cohesion: 0.13
...
### Community 117 - "Copywriting Formulas"
Cohesion: 0.13
...
### Community 119 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)

### Community 120 - ".agents/skills/design-system/scripts/generate-slide.py"
Cohesion: 0.14
Nodes (20): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+12 more)

### Community 121 - "CIP Design Reference"
Cohesion: 0.13
Nodes (14): CIP Brief (Start Here), CIP Design Reference, Commands, Deliverable Categories, Design Styles, Detailed References, Generate Mockups, HTML Presentation Features (+6 more)

### Community 122 - "Icon Design Reference"
Cohesion: 0.13
Nodes (14): Available Styles, CLI Options, Commands, Generate Batch Variations, Generate Multiple Sizes, Generate Single Icon, Icon Categories, Icon Design Reference (+6 more)
...
### Community 125 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)
...
### Community 129 - ".agents/skills/brand/scripts/extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 130 - ".agents/skills/brand/scripts/validate-asset.cjs"
Cohesion: 0.25
...
### Community 137 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
Nodes (13): Art Direction Styles (Top 10), Banner Design - Multi-Format Creative Banner System, Banner Size Quick Reference, Design Rules, Prerequisites, Security, Step 1: Gather Requirements (AskUserQuestion), Step 2: Research & Art Direction (+5 more)

### Community 138 - "Messaging Framework"
Cohesion: 0.14
Nodes (13): Core Statements, Elevator Pitches, Framework Structure, Message Architecture, Message by Audience, Message Testing, Messaging Framework, Mission Statement (+5 more)

### Community 139 - "Brand Voice Framework"
Cohesion: 0.14
Nodes (13): Brand Voice Framework, Character Spectrum, Emotion Spectrum, Language Spectrum, Step 1: Define Personality Traits, Step 2: Create Voice Chart, Step 3: Context Adaptation, Tone Spectrum (+5 more)

### Community 140 - ".trae/skills/brand/scripts/extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 141 - ".trae/skills/brand/scripts/validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 142 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 143 - "Tailwind Integration"
Cohesion: 0.14
Nodes (13): Animation Tokens, Base Layer, Button Example, Component Classes, CSS Variables Setup, Dark Mode Toggle, HSL Format Benefits, shadcn/ui Alignment (+5 more)

### Community 144 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 145 - ".agents/skills/brand/references/update.md"
Cohesion: 0.15
...
### Community 146 - "Logo Design Reference"
Cohesion: 0.15
...
### Community 147 - "Token Architecture"
Cohesion: 0.15
...
### Community 148 - ".agents/skills/design-system/templates/design-tokens-starter.json"
Cohesion: 0.15
...
### Community 150 - "HowItWorksClient.tsx"
Cohesion: 0.17
Nodes (6): metadata, HowItWorksClient(), steps, metadata, metadata, next

### Community 151 - "package.json"
Cohesion: 0.12
Nodes (14): name, private, version, autoprefixer, eslint, eslint-config-next, postcss, react-dom (+6 more)

### Community 152 - "@supabase/supabase-js"
Cohesion: 0.09
Nodes (9): @supabase/supabase-js, { createClient }, { createClient }, { createClient }, { createClient }, { createChunks }, { createClient }, results (+1 more)

### Community 153 - ".trae/skills/brand/references/update.md"
Cohesion: 0.15
Nodes (12): Color Presets, Examples, Files Modified, Important, Overview, Skills Used, Step 1: Gather Brand Input, Step 2: Update Brand Guidelines (+4 more)

### Community 154 - "Logo Design Reference"
Cohesion: 0.15
Nodes (12): Available Styles, Color Psychology, Commands, Design Brief (Start Here), Detailed References, Generate Logo, Industry Defaults, Logo Design Reference (+4 more)
...
### Community 156 - "Token Architecture"
Cohesion: 0.15
Nodes (12): Categories, Dark Mode, File Organization, Layer 1: Primitive Tokens, Layer 2: Semantic Tokens, Layer 3: Component Tokens, Layer Overview, Migration from Flat Tokens (+4 more)

### Community 157 - ".trae/skills/design-system/templates/design-tokens-starter.json"
Cohesion: 0.15
Nodes (12): component, $type, $value, dark, semantic, $schema, $type, $value (+4 more)

### Community 158 - "Primitive Tokens"
Cohesion: 0.17
...
### Community 159 - ".agents/skills/design-system/scripts/validate-tokens.cjs"
Cohesion: 0.26
...
### Community 162 - ".agents/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py"
Cohesion: 0.14
...
Cohesion: 0.17
Nodes (11): Part 1 — Guest / First-Time Visitor Flows, Part 2 — Auth Flows, Part 3 — Contact Seller (Core Trust Flow), Part 4 — Sell / Edit / Dashboard Flows, Part 5 — Report Flow, Part 6 — Admin Flows, Part 7 — Security / RLS Spot-Checks, Part 8 — Contact Us (Support Form) (+3 more)

### Community 164 - "Primitive Tokens"
Cohesion: 0.17
Nodes (11): Border Radius, Color Scales, Gray Scale, Motion / Duration, Primary Colors (Blue), Primitive Tokens, Shadows, Spacing Scale (+3 more)

### Community 165 - ".trae/skills/design-system/scripts/validate-tokens.cjs"
Cohesion: 0.26
Nodes (11): extensions, formatReport(), fs, getFiles(), main(), parseArgs(), path, patterns (+3 more)
...
### Community 167 - ".agents/skills/brand/scripts/inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 168 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 169 - ".agents/skills/design-system/scripts/embed-tokens.cjs"
Cohesion: 0.18
Nodes (8): args, fs, minimal, MINIMAL_TOKENS, path, projectRoot, tokensPath, wrapStyle

### Community 170 - "dependencies"
Cohesion: 0.18
Nodes (11): dependencies, framer-motion, lucide-react, nanoid, next, react, react-dom, resend (+3 more)

### Community 171 - ".trae/skills/brand/scripts/inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 172 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 173 - "TestThresholdGate"
Cohesion: 0.12
Nodes (4): Unit tests for metric math and relevance fixture validation., TestFixtureValidation, TestMetricMath, TestThresholdGate

### Community 174 - ".trae/skills/design-system/scripts/embed-tokens.cjs"
Cohesion: 0.18
Nodes (8): args, fs, minimal, MINIMAL_TOKENS, path, projectRoot, tokensPath, wrapStyle

### Community 175 - "duration"
Cohesion: 0.20
...
### Community 179 - ".agents/skills/design-system/scripts/generate-tokens.cjs"
Cohesion: 0.40
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)

### Community 180 - "button"
Cohesion: 0.20
Nodes (10): fg, font-size, hover-bg, button, $type, $value, $type, $value (+2 more)

### Community 181 - "duration"
Cohesion: 0.20
Nodes (10): fast, normal, slow, $type, $value, $type, $value, duration (+2 more)

### Community 182 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 183 - ".agents/skills/design/scripts/icon/generate.py"
Cohesion: 0.18
Nodes (16): apply_color(), apply_viewbox_size(), extract_svgs(), generate_batch(), generate_icon(), generate_sizes(), load_env(), main() (+8 more)
...
### Community 186 - "_palette_is_dark"
Cohesion: 0.18
...
### Community 188 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 189 - "Component Tokens"
Cohesion: 0.20
Nodes (9): Alert Tokens, Badge Tokens, Button Tokens, Card Tokens, Component Tokens, Dialog/Modal Tokens, Input Tokens, Table Tokens (+1 more)

### Community 190 - ".trae/skills/design-system/scripts/generate-tokens.cjs"
Cohesion: 0.40
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)

### Community 191 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 192 - ".check_shadcn_config"
Cohesion: 0.21
Nodes (6): Add all available shadcn/ui components. Args: overwrite: If True, overwrite…, List installed components. Returns: Tuple of (success, message with component…, Check if shadcn is initialized in project. Returns: True if components.json…, Get list of already installed components. Returns: List of installed component…, Read shadcn version from project package.json; fall back to a pinned default., Add shadcn/ui components. Args: components: List of component names to add…
...
### Community 194 - ".agents/skills/brand/scripts/sync-brand-to-tokens.cjs"
Cohesion: 0.33
Nodes (8): adjustBrightness(), { execFileSync }, extractColorsFromMarkdown(), fs, generateColorScale(), main(), path, updateDesignTokens()

### Community 195 - "_row_identities"
Cohesion: 0.25
...
### Community 196 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 197 - "server.ts"
Cohesion: 0.18
Nodes (9): cleanupListingImages(), DELETE(), POST(), RouteContext, RouteContext, GET(), GET(), createClient() (+1 more)

### Community 198 - "Core Visual Elements"
Cohesion: 0.18
Nodes (10): Color Palette, Colors, Core Visual Elements, Logo, Logo, Quick Checks, Typography, Typography (+2 more)

### Community 199 - ".trae/skills/brand/scripts/sync-brand-to-tokens.cjs"
Cohesion: 0.33
Nodes (8): adjustBrightness(), { execFileSync }, extractColorsFromMarkdown(), fs, generateColorScale(), main(), path, updateDesignTokens()
...
### Community 201 - "Slides Reference"
Cohesion: 0.29
Nodes (6): Key Features, Knowledge Base, Slides Reference, Usage, When to Use, Workflow

### Community 202 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 203 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 204 - "parse_decision_rules"
Cohesion: 0.17
...
### Community 205 - "Slides Reference"
Cohesion: 0.29
Nodes (6): Key Features, Knowledge Base, Slides Reference, Usage, When to Use, Workflow

### Community 206 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 207 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 208 - ".trae/skills/design-system/scripts/slide-token-validator.py"
Cohesion: 0.50
...
### Community 209 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 210 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 211 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 212 - "Brand Guidelines Template"
Cohesion: 0.40
Nodes (4): Brand Guidelines Template, Document Structure, Extractable Fields, Usage

### Community 214 - ".agents/skills/design/scripts/logo/core.py"
Cohesion: 0.10
Nodes (21): BM25, detect_domain(), _load_csv(), Load CSV and return list of dicts, Core search function using BM25, Auto-detect the most relevant domain from query, Main search function with auto-domain detection, Search across all domains and combine results (+13 more)

### Community 215 - "listings/route.ts"
Cohesion: 0.15
Nodes (10): RouteContext, POST(), generateNanoId, generateSlug(), CreateListingInput, createListingSchema, listingConditions, UpdateListingInput (+2 more)

### Community 216 - ".agents/skills/design-system/scripts/slide_search_core.py"
Cohesion: 0.08
Nodes (38): format_context(), format_result(), main(), Format a single search result for display, Slide Search CLI - Search slide design databases for strategies, layouts, copy,…, Format contextual recommendations for display., BM25, calculate_pattern_break() (+30 more)
...
### Community 223 - ".generate_config_string"
Cohesion: 0.20
Nodes (6): Generate configuration file content. Returns: Configuration file as string, Generate TypeScript configuration., Generate JavaScript configuration., Format plugins array for config. Validates each plugin name against a strict…, Add indentation to JSON string., Write configuration to file. Returns: Tuple of (success, message)

### Community 224 - ".generate_config_string"
Cohesion: 0.20
Nodes (6): Generate configuration file content. Returns: Configuration file as string, Generate TypeScript configuration., Generate JavaScript configuration., Format plugins array for config. Validates each plugin name against a strict…, Add indentation to JSON string., Write configuration to file. Returns: Tuple of (success, message)

### Community 225 - ".trae/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py"
Cohesion: 0.15
Nodes (11): _filter_anti_patterns_for_mode(), _query_wants_dark(), True when a styles.csv row describes itself as dark-first., True when the query explicitly asks for a dark theme., Resolve the mode the rest of the output has to agree with., Drop "avoid dark mode" advice once dark mode is the resolved answer., _resolve_color_mode(), _style_is_dark_primary() (+3 more)

### Community 226 - "Contact Reveal API"
Cohesion: 0.40
Nodes (5): Browse to Contact Seller Flow, Phase 3 Contact Flow, Contact Reveal, Marketplace Bridge, Contact Reveal API

### Community 227 - "UniDeal Product Requirements"
Cohesion: 0.50
...
### Community 228 - ".agents/skills/design/scripts/logo/generate.py"
Cohesion: 0.25
...
### Community 229 - "Brand Guidelines Template"
Cohesion: 0.40
Nodes (4): Brand Guidelines Template, Document Structure, Extractable Fields, Usage
...
### Community 231 - ".agents/skills/ui-styling/scripts/tests/test_tailwind_config_gen.py"
Cohesion: 0.22
Nodes (8): parametrize, Tests for tailwind_config_gen.py, Reduce a generated TS/JS config to a bare assignable object so it can be handed…, Regression guard for the missing-comma bug between the ``theme`` block and…, The property preceding ``plugins`` must end with a comma (pure-Python check, so…, The emitted config parses as valid JS via ``node --check``., _strip_to_object(), TestGeneratedConfigIsValidJs

### Community 232 - ".agents/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py"
Cohesion: 0.20
Nodes (4): Canonical regression contracts for resilient UI text layouts., read_rows(), TestTextLayoutDataContracts, TestTextLayoutRetrieval

### Community 233 - "padding-y"
Cohesion: 0.67
...
### Community 236 - "Row Level Security Policies"
Cohesion: 0.50
...
### Community 245 - "destructive-foreground"
Cohesion: 0.67
...
### Community 250 - "TestShadcnInstaller"
Cohesion: 0.12
Nodes (9): Tests for shadcn_add.py, Test ShadcnInstaller class., Test adding all components without config., Test listing installed components without config., Test listing installed components when they exist., Test initialization with default project root., Test initialization with dry run mode., Test getting installed components when files exist. (+1 more)

### Community 251 - ".trae/skills/design/scripts/logo/generate.py"
Cohesion: 0.25
Nodes (10): enhance_prompt(), generate_batch(), generate_logo(), load_env(), main(), Enhance the logo prompt with style and industry modifiers, Generate a logo using Gemini models with image generation Args: aspect_ratio:…, Generate multiple logo variants with different styles (+2 more)

### Community 255 - "ShadcnInstaller"
Cohesion: 0.17
...
### Community 256 - "._base_config"
Cohesion: 0.22
Nodes (6): Any, Path, Initialize generator. Args: typescript: If True, generate .ts config, else .js…, Determine default output path., Create base configuration structure., Get default content paths for framework.

### Community 258 - "generate_design_system"
Cohesion: 0.22
...
### Community 261 - "TestTailwindConfigGenerator"
Cohesion: 0.07
Nodes (15): Test adding colors multiple times., Test adding custom fonts., Test adding custom breakpoints., Test TailwindConfigGenerator class., Test plugin recommendations for Next.js., Test generating JavaScript configuration., Test generating config with custom colors., Test validating config with no content paths. (+7 more)

### Community 264 - ".agents/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py"
Cohesion: 0.19
...
### Community 309 - ".agents/skills/design-system/scripts/slide-token-validator.py"
Cohesion: 0.50
Nodes (3): main(), Slide Token Validator (Legacy Wrapper) Now delegates to html-token-validator.py…, Delegate to unified html-token-validator.py with --type slides.

### Community 310 - "Tips for Better Results"
Cohesion: 0.50
...
### Community 321 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 322 - "destructive-foreground"
Cohesion: 0.67
Nodes (3): destructive-foreground, $type, $value
...
### Community 324 - "primary-foreground"
Cohesion: 0.67
Nodes (3): primary-foreground, $type, $value
...
### Community 360 - "_palette_is_dark"
Cohesion: 0.18
Nodes (7): _palette_is_dark(), WCAG relative luminance of a #RRGGBB string, or None if unparseable., True when a colors.csv row's Background is a dark surface., _relative_luminance(), The exact reproduction from issue #428., TestEndToEndCoherence, TestLuminance

### Community 361 - "[slug]/page.tsx"
Cohesion: 0.14
Nodes (13): ListingDetailClient(), ListingDetailClientProps, conditionBadges, ListingDetailPage(), ListingDetailPageProps, ListingDetailRow, AnimatedCard(), conditionColors (+5 more)

### Community 362 - "reject/route.ts"
Cohesion: 0.20
Nodes (7): PATCH(), rejectSchema, RouteContext, reportSchema, RouteContext, validReportReasons, zod

### Community 363 - "ContactForm.tsx"
Cohesion: 0.29
Nodes (6): POST(), FieldErrors, getResendClient(), ContactInput, contactSchema, resend

### Community 364 - "seed_admin_and_listings.js"
Cohesion: 0.20
Nodes (7): nanoid, { createClient }, DUMMY_LISTINGS, envPath, fs, path, seed()

### Community 365 - "devDependencies"
Cohesion: 0.18
Nodes (11): devDependencies, autoprefixer, eslint, eslint-config-next, @playwright/test, postcss, tailwindcss, @types/node (+3 more)

### Community 367 - "admin/layout.tsx"
Cohesion: 0.50
...
### Community 369 - "ContactForm"
Cohesion: 1.00
Nodes (3): ContactForm(), handleSubmit(), validate()

### Community 370 - "_normalize"
Cohesion: 0.22
...
### Community 371 - "test_whatsapp_and_delete_account.js"
Cohesion: 0.22
Nodes (4): { createChunks }, { createClient }, results, { stringToBase64URL }

### Community 372 - "_row_identities"
Cohesion: 0.25
Nodes (8): _exact_row_identity(), Suggest complete public identities so a retry can bypass score thresholds., Return non-empty public identities from ordinary and alias fields., Resolve an explicit style identity without opening generic variant ranking., Return one row whose stable public identity exactly matches the query., _row_identities(), _style_identity(), _suggest_identities()
...
## Knowledge Gaps
- **2056 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2051 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2882 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **78 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `BM25`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_design_system_mode.py`, `.agents/skills/ui-ux-pro-max/scripts/design_system.py`, `.agents/skills/ui-ux-pro-max/scripts/tests/test_data_contracts.py`, `_palette_is_dark`, `_palette_is_dark`, `read_rows`, `_select_palette_for_mode`, `.generate`, `DesignSystemGenerator`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `TestReasoningMatch` connect `DesignSystemGenerator` to `BM25`, `DesignSystemGenerator`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `search_stack()` connect `search_stack` to `generate_design_system`, `BM25`, `.trae/skills/ui-ux-pro-max/scripts/core.py`, `.trae/skills/ui-ux-pro-max/scripts/tests/test_text_layout_resilience.py`, `search`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
...
- **Should `.trae/skills/ui-ux-pro-max/scripts/validate_data.py` be split into smaller, more focused modules?**
