                            ...
                            <div style={{
                                ...
                                {l.status !== "sold" && !l.isExpired && (
                                    <button
                                        ...
                                        style={{ flex: 1, padding: "8px 16px", borderRadius: "var(--r)", border: "1.5px solid var(--border-2)", background: "var(--surface)", fontSize: 12, fontWeight: 600, cursor: "pointer", height: 38 }}
                                    >
                                        Mark Sold
                                    </button>
                                )}
                                <button
                                    ...
                                    style={{ flex: 1, padding: "8px 16px", borderRadius: "var(--r)", border: "none", background: "var(--red-bg)", color: "var(--red)", fontSize: 12, fontWeight: 600, cursor: "pointer", height: 38 }}
                                >
                                    Delete
                                </button>
                            </div>
